 ...
 * \author Julien Jorge
 */
#ifndef __RP_ANDROID_GAME_FILESYSTEM_HPP__
#define __RP_ANDROID_GAME_FILESYSTEM_HPP__
...
namespace rp
{
  ...
  class android_game_filesystem:
    public bear::engine::default_game_filesystem
  {
  public:
...
#endif // __RP_ANDROID_GAME_FILESYSTEM_HPP__
