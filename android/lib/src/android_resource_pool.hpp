 ...
 * \author Julien Jorge
 */
#ifndef __RP_ANDROID_RESOURCE_POOL_HPP__
#define __RP_ANDROID_RESOURCE_POOL_HPP__
...
namespace rp
{
  ...
  class android_resource_pool:
    public bear::engine::base_resource_pool
  {
  public:
...
#endif // __RP_ANDROID_RESOURCE_POOL_HPP__
