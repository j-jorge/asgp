...
CLAW_LIBRARIES="$(get_all_static_libraries claw)"
...
SHARED_LIBRARIES="-Wl,-Bdynamic \
  ...
  -ldl \
"
EXE_MODULE_LINK_ORDER="rp generic_items"
...
(
    echo all: $BINARY_ROOT/bin/andy-super-great-park
    echo
